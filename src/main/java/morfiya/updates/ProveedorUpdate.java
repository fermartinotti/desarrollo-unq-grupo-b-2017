...
public class ProveedorUpdate extends Entity{
	...
	public ProveedorUpdate(String nombre, Servicio servicio, Double creditos, String email) {
		super();
		if(nombre!=null)
	...
	public ProveedorUpdate(String nombre, String email) {
		super();
		if(nombre!=null)
			this.setNombre(nombre);
