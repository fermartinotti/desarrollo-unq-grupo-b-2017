...
public class MenuBuilder {
	...
	public Menu build() {
		Menu menu = new Menu(this.nombre, this.descripcion, this.categoria, this.valorDelivery, this.fechaVigenciaDesde.toString(),
				this.fechaVigenciaHasta.toString(), this.precio, this.cantidadMinima, this.cantidadMinima2,
				this.precioCantidadMinima, this.precioCantidadMinima2,this.cantidadMaxVtasPorDia);
